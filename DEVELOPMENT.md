...
| `admin_enqueue_scripts` | `fictioneer_admin_scripts` (10), `fictioneer_admin_styles` (10), `\Fictioneer\Role::hide_private_comment_data` (20)
| `admin_footer.php` | `\Fictioneer\Role::classic_editor_js_restrictions` (10), `\Fictioneer\Role::hide_permalink_with_js` (10)
| `admin_head` | `\Fictioneer\Role::remove_update_notice` (10), `fictioneer_output_head_fonts` (5), `\Fictioneer\Role::hide_permalink_with_css` (10), `\Fictioneer\Role::hide_inserter_media_tab_with_css` (10), `\Fictioneer\Role::classic_editor_css_restrictions` (10), `\Fictioneer\Role::remove_profile_blocks` (10)
| `admin_init` | `fictioneer_register_settings` (10), `\Fictioneer\Role::skip_dashboard` (10), `fictioneer_initialize_roles` (10), `fictioneer_bring_out_legacy_trash` (10), `\Fictioneer\Role::restrict_admin_panel` (10)
| `admin_menu` | `fictioneer_add_admin_menu` (10), `\Fictioneer\Role::remove_dashboard_menu` (10), `\Fictioneer\Role::remove_comments_menu_page` (10), `fictioneer_remove_sub_menus` (10), `\Fictioneer\Role::remove_post_menu_page` (99), `\Fictioneer\Role::reduce_admin_panel` (99)
...
| `current_screen` | `\Fictioneer\Role::block_admin_only_screens` (10), `\Fictioneer\Role::restrict_comment_screens` (10)
...
| `pre_get_posts` | `fictioneer_extend_search_query` (11), `\Fictioneer\Role::limit_media_ajax_query_attachments` (10), `\Fictioneer\Role::limit_media_list_view` (10), `fictioneer_filter_chapters_by_story` (10), `fictioneer_extend_taxonomy_pages` (10), `\Fictioneer\Role::limit_posts_to_author` (10), `fictioneer_add_sof_to_taxonomy_query` (10)
...
| `wp_count_posts` | `\Fictioneer\Role::filter_counts_by_author` (10)
| `wp_dashboard_setup` | `\Fictioneer\Role::remove_dashboard_widgets` (10)
...
| `allowed_block_types_all` | `fictioneer_allowed_block_types` (10), `\Fictioneer\Role::restrict_block_types` (20)
...
| `comment_row_actions` | `\Fictioneer\Role::remove_comment_quick_edit` (10)
...
| `manage_users_columns` | `\Fictioneer\Role::hide_users_columns` (10)
| `map_meta_cap` | `\Fictioneer\Role::prevent_editing_others_attachments` (10), `\Fictioneer\Role::prevent_deleting_others_attachments` (9999), `fictioneer_override_default_taxonomy_capability_check` (9999), `fictioneer_edit_comments` (10)
...
| `wp_insert_post_data` | `Fictioneer\Role::remove_restricted_block_content` (1), `\Fictioneer\Role::strip_shortcodes_on_save` (1), `fictioneer_see_some_evil` (1), `Fictioneer\Role::prevent_publish_date_update` (1), `\Fictioneer\Role::prevent_parent_and_order_update` (1), `fictioneer_prevent_track_and_ping_updates` (1), `\Fictioneer\Role::prevent_permalink_edit` (99)
