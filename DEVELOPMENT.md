...
| ---: | :--- |
| `add_meta_boxes` | `fictioneer_add_seo_metabox` (10), `\Fictioneer\Role_Admin::restrict_classic_metaboxes` (10), `fictioneer_add_story_meta_metabox` (10), `fictioneer_add_story_data_metabox` (10), `fictioneer_add_story_epub_metabox` (10), `fictioneer_add_chapter_meta_metabox` (10), `fictioneer_add_chapter_data_metabox` (10), `fictioneer_add_extra_metabox` (10), `fictioneer_add_support_links_metabox` (10), `fictioneer_add_featured_content_metabox` (10), `fictioneer_add_collection_data_metabox` (10), `fictioneer_add_recommendation_data_metabox` (10)
| `add_meta_boxes_comment` | `fictioneer_add_comment_meta_box` (10)
| `admin_bar_menu` | `fictioneer_adminbar_add_chapter_link` (99), `\Fictioneer\Role::remove_admin_bar_new_post` (99)
| `admin_enqueue_scripts` | `fictioneer_admin_scripts` (10), `fictioneer_admin_styles` (10), `\Fictioneer\Role_Admin::hide_private_comment_data` (20)
| `admin_footer.php` | `\Fictioneer\Role_Admin::classic_editor_js_restrictions` (10), `\Fictioneer\Role_Admin::hide_permalink_with_js` (10)
| `admin_head` | `\Fictioneer\Role_Admin::remove_update_notice` (10), `fictioneer_output_head_fonts` (5), `\Fictioneer\Role_Admin::hide_permalink_with_css` (10), `\Fictioneer\Role_Admin::hide_inserter_media_tab_with_css` (10), `\Fictioneer\Role_Admin::classic_editor_css_restrictions` (10), `\Fictioneer\Role_Admin::remove_profile_blocks` (10)
| `admin_init` | `fictioneer_register_settings` (10), `\Fictioneer\Role_Admin::skip_dashboard` (10), `\Fictioneer\Role::initialize_roles` (10), `fictioneer_bring_out_legacy_trash` (10), `\Fictioneer\Role_Admin::restrict_admin_panel` (10)
| `admin_menu` | `fictioneer_add_admin_menu` (10), `\Fictioneer\Role_Admin::remove_dashboard_menu` (10), `\Fictioneer\Role_Admin::remove_comments_menu_page` (10), `fictioneer_remove_sub_menus` (10), `\Fictioneer\Role_Admin::remove_post_menu_page` (99), `\Fictioneer\Role_Admin::reduce_admin_panel` (99)
| `admin_notices` | `fictioneer_admin_profile_notices` (10), `fictioneer_admin_settings_notices` (10), `fictioneer_admin_update_notice` (10)
| `admin_post_*` | `fictioneer_delete_all_epubs` (10), `fictioneer_tools_add_moderator_role` (10), `fictioneer_tools_move_story_tags_to_genres` (10), `fictioneer_tools_duplicate_story_tags_to_genres` (10), `fictioneer_tools_purge_theme_caches` (10), `fictioneer_tools_move_chapter_tags_to_genres` (10), `fictioneer_tools_duplicate_chapter_tags_to_genres` (10), `fictioneer_tools_append_default_genres` (10), `fictioneer_tools_append_default_tags` (10), `fictioneer_tools_remove_unused_tags` (10), `fictioneer_admin_profile_unset_oauth` (10), `fictioneer_admin_profile_clear_data_node` (10), `fictioneer_update_frontend_profile` (10), `fictioneer_cancel_frontend_email_change` (10), `fictioneer_add_role` (10), `fictioneer_remove_role` (10), `fictioneer_rename_role` (10), `fictioneer_connection_get_patreon_tiers` (10), `fictioneer_connection_delete_patreon_tiers` (10)
...
| `current_screen` | `\Fictioneer\Role::block_admin_only_screens` (10), `\Fictioneer\Role_Admin::restrict_comment_screens` (10)
...
| `wp_before_admin_bar_render` | `fictioneer_remove_admin_bar_links` (10), `\Fictioneer\Role::remove_dashboard_from_admin_bar` (10), `\Fictioneer\Role::remove_comments_from_admin_bar` (10)
| `wp_count_posts` | `\Fictioneer\Role_Admin::filter_counts_by_author` (10)
| `wp_dashboard_setup` | `\Fictioneer\Role_Admin::remove_dashboard_widgets` (10)
...
| `allowed_block_types_all` | `fictioneer_allowed_block_types` (10), `\Fictioneer\Role_Admin::restrict_block_types` (20)
| `block_editor_settings_all` | `fictioneer_disable_font_library` (10), `fictioneer_add_editor_css` (10), `fictioneer_modify_editor_settings` (10)
...
| `comment_row_actions` | `\Fictioneer\Role_Admin::remove_comment_quick_edit` (10)
...
| `delete_post_metadata` | `fictioneer_update_chapter_metadata_stop_cron` (10)
...
| `manage_pages_columns` | `\Fictioneer\Role_Admin::remove_comments_column` (10)
| `manage_posts_columns` | `\Fictioneer\Role_Admin::remove_comments_column` (10)
| `manage_users_columns` | `\Fictioneer\Role_Admin::hide_users_columns` (10)
| `map_meta_cap` | `\Fictioneer\Role_Admin::prevent_editing_others_attachments` (10), `\Fictioneer\Role_Admin::prevent_deleting_others_attachments` (9999), `fictioneer_override_default_taxonomy_capability_check` (9999), `fictioneer_edit_comments` (10)
...
| `post_password_required` | `\Fictioneer\Role::bypass_password` (10), `fictioneer_expire_post_password` (5)
| `post_stuck` | `\Fictioneer\Role_Admin::prevent_post_sticky` (10)
...
| `robots_txt` | `fictioneer_robots_txt` (1), `fictioneer_robots_txt_exclusions` (10)
...
| `the_content` | `fictioneer_append_footnotes_to_content` (20), `fictioneer_add_lightbox_to_post_images` (15), `fictioneer_add_chapter_paragraph_id` (10), `fictioneer_replace_br_with_whitespace` (6), `fictioneer_fix_line_breaks` (1)
...
| `theme_templates` | `\Fictioneer\Role_Admin::disallow_page_template_select` (1)
| `tiny_mce_plugins` | `fictioneer_disable_tiny_mce_emojis` (10)
| `update_post_metadata` | `\Fictioneer\Role_Admin::prevent_page_template_update` (1), `fictioneer_update_chapter_metadata_stop_cron` (10)
...
| `user_has_cap` | `\Fictioneer\Role_Admin::edit_only_comments` (10)
| `wp_list_comments_args` | `fictioneer_comment_list_args` (10)
| `wp_handle_upload_prefilter` | `\Fictioneer\Role::upload_restrictions` (10)
| `wp_insert_post_data` | `Fictioneer\Role_Admin::remove_restricted_block_content` (1), `\Fictioneer\Role_Admin::strip_shortcodes_on_save` (1), `fictioneer_see_some_evil` (1), `Fictioneer\Role_Admin::prevent_publish_date_update` (1), `\Fictioneer\Role_Admin::prevent_parent_and_order_update` (1), `fictioneer_prevent_track_and_ping_updates` (1), `\Fictioneer\Role_Admin::prevent_permalink_edit` (99)
